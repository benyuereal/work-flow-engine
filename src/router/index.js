...
export const otherRouterMap = [
  {
    ...
    component: Layout,
    redirect: '/test/index',
    children: [{path: 'index',  icon: 'social-codepen-outline',title: '入口管理', name: 'testIndex', component: _import('dashboard/mm')}]
  },
  {
    path: '/result',
    icon: 'ios-keypad',
    ...
    children: [{path: 'index',  icon: 'compose',title: '流程配置', name: 'result', component: _import('dashboard/index')}]
  },
  {
    path: '/configuration',
    icon: 'navicon',
